...
const DoctorSearchPage = ({ defaultSpecialty = "" }) => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const res = await axios.get("https://aivisioncare.onrender.com/api/search-doctors", {
  ...
  return (
    <div className="p-6 space-y-6 bg-white dark:bg-neutral-950 rounded-lg shadow-lg">
      <h1 className="text-3xl font-semibold text-neutral-900 dark:text-neutral-100 mb-4 flex items-center gap-2">
      ...
      <div className="grid gap-6 pt-6">
        ...
        {paginatedDoctors.map((doc, idx) => (
          <div
            key={idx}
            className="border border-neutral-300 dark:border-neutral-700 p-5 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300"
          >
            <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mb-1 flex items-center gap-2">
              <UserSearch size={20} /> {doc.name}
            </h2>
            <p className="text-neutral-600 dark:text-neutral-300 mb-1">
              <strong>Specialty: </strong> {doc.specialty}
            </p>
            <p className="text-neutral-600 dark:text-neutral-300 mb-1 flex items-center gap-2">
              <MapPin size={16} /> {doc.location}
            </p>
            <p className="text-neutral-600 dark:text-neutral-300 mb-3 flex items-center gap-2">
