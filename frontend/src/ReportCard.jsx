        ...
        <TabsContent value="summary" className="pt-3">
          <CardContent>
            <div className="mb-4">
              ...
              <p className="text-base font-medium text-orange-600 dark:text-orange-400">{diagnosis}</p>
            </div>
            ...
            <ul className="space-y-2">
              {symptoms.length ? symptoms.map((symptom, index) => (
                <li key={index} className="flex items-start gap-2">
                  <div className="mt-0.5 rounded-full bg-orange-100 dark:bg-orange-900/30 p-1">
