...
const LandingPage = () => {
  return (
    <div className="flex flex-col w-full">
      {/* <SmoothCursor /> */}
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-white via-white to-orange-100 dark:bg-gradient-to-br dark:from-black dark:via-black dark:to-orange-950 text-black dark:text-white py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center rounded-full border border-orange-200 dark:border-orange-800 bg-white dark:bg-orange-950/50 px-3 py-1 text-sm text-black dark:text-orange-200">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 text-lg md:text-xl max-w-md">
              ...
              <div className="pt-4 flex flex-wrap gap-4">
                ...
                <a href="#features">
                  <RippleButton className='rounded-full'><span className='flex items-center justify-center gap-2 font-smeibold'>Learn More <ChevronDownCircleIcon className='text-neutral-500' /></span></RippleButton>
                </a>

              </div>

              <div className="pt-6 flex items-center text-black dark:text-neutral-400 text-sm">
                <div className="flex -space-x-2 mr-3">
                  <div className="h-8 w-8 rounded-full bg-orange-500 flex items-center justify-center text-xs font-medium text-white">JD</div>
                  <div className="h-8 w-8 rounded-full bg-orange-700 flex items-center justify-center text-xs font-medium text-white">SL</div>
      ...
      <section id="features" className="py-16 bg-white dark:bg-neutral-950">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <Card className="border-2 shadow-md hover:shadow-lg transition-shadow duration-300 dark:border-neutral-800">
              <CardContent className="pt-6">
                <div className="rounded-lg bg-orange-50 dark:bg-orange-950/30 p-3 w-12 h-12 flex items-center justify-center mb-4">
            ...
            <Card className="border-2 shadow-md hover:shadow-lg transition-shadow duration-300 dark:border-neutral-800">
              <CardContent className="pt-6">
                <div className="rounded-lg bg-amber-50 dark:bg-amber-950/30 p-3 w-12 h-12 flex items-center justify-center mb-4">
            ...
            <Card className="border-2 shadow-md hover:shadow-lg transition-shadow duration-300 dark:border-neutral-800">
              <CardContent className="pt-6">
                <div className="rounded-lg bg-red-50 dark:bg-red-950/30 p-3 w-12 h-12 flex items-center justify-center mb-4">
      ...
      {/* security claim */}
      <section className='mx-auto py-16 w-full px-2 md:px-44 bg-white dark:bg-neutral-950'>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <Button
                asChild
                size="lg"
                className="bg-orange-500 hover:bg-orange-600 text-white px-8 shadow-lg rounded-full transition-transform transform hover:scale-105"
              >
                <Link to="/upload">
      ...
      {/* Contact Section */}
      <section className="py-16 px-4 md:px-96 flex items-center justify-between bg-white dark:bg-neutral-950 transition-colors gap-2">
        <div className="container">
          <div className="mb-12">
            <h2 className="text-3xl font-bold tracking-tight mb-2 text-neutral-900 dark:text-white">
              Get in Touch
            </h2>
          ...
          <div className="flex">
            <Button
              asChild
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-white px-8 shadow-lg rounded-full transition-transform transform hover:scale-105 text-sm font-bold"
            >
      ...
      className="flex items-center justify-center overflow-hidden rounded-2xl border-2 bg-neutral-100 dark:bg-neutral-800"
      gradientColors={["#F97316", "#EA580C", "#FDBA74"]}
    >
      ...
      <>
        ...
        <div className="flex items-center justify-center bg-white dark:bg-neutral-950 py-5">
          <Feedback />
        </div>
      </>
