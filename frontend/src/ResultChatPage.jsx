...
const BASE_API_URL = 'https://aivisioncare.onrender.com';
            ...
            {messages.map((msg, idx) => (
              <div
                ...
                className={`p-3 rounded-md text-sm max-w-[80%] ${
                  msg.role === 'ai'
                    ? 'bg-orange-100 dark:bg-orange-900/40 text-orange-800 dark:text-orange-100 font-semibold self-start'
                    : 'bg-neutral-900 dark:bg-white text-white dark:text-black font-semibold self-end ml-auto'
                }`}
              >
                {msg.text}
              </div>
